...
export default function Projects({
  ...
  projects: Project[];
  setHoveredProject: (name: Project["name"] | null) => void;
  setHoveredTag: (tag: Project["tags"][number] | null) => void;
}) {
  return (
    <table className="w-full table-auto">
      <thead>
        <tr>
          ...
          <th className="font-normal text-left green hidden md:table-cell">
            tags
          </th>
        ...
        {projects.map((project) => (
          ...
          >
            <td className="pr-4 align-top">
              <Link href={project.url} className="blue underline font-semibold">
                {project.name}
              </Link>
            </td>
